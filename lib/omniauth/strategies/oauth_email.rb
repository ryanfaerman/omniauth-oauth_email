...
module OmniAuth
  module Strategies
    class OAuthEmail < OmniAuth::Strategies::OAuth2
      option :client_options, {
        :site => 'http://localhost:9292',
        :authorize_url => 'http://localhost:9292/oauth/authorize',
        :token_url => 'http://localhost:9292/oauth/access_token'
      }
...
OmniAuth.config.add_camelization 'oauth_email', 'OAuthEmail'
